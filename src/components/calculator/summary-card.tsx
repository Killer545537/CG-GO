...
export function SummaryCard({ cgpa, credits }: SummaryCardProps) {
    return (
        <div className='bg-neutral-900 border border-neutral-800 rounded-xl p-8 mb-8 text-center md:text-left shadow-lg'>
            <h3 className='text-base font-medium uppercase tracking-wider text-neutral-500 mb-2'>
                Current CGPA
            </h3>
            <div className='text-6xl font-mono font-bold tracking-tighter text-neutral-50 mb-4'>
                {cgpa.toFixed(2)}
            </div>
